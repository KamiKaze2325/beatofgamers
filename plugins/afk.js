...
MARAYA.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
MARAYA.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
MARAYA.addCommand({pattern: 'afk ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
