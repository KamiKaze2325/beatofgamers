...
if (Config.WORKTYPE == 'private') {
    ...
    MARAYA.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    MARAYA.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
